  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10 col-lg-9">
        ...
        <h3 class="mt-5">Comment ça s'organise avec votre structure</h3>
        <ol>
          <li>Premier échange pour cerner le contexte et les besoins du groupe</li>
          <li>Proposition d'un format (fréquence, durée, tarif) et d'un devis</li>
